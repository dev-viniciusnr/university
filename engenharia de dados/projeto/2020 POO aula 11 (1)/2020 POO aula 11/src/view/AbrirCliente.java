...
public class AbrirCliente extends javax.swing.JPanel {
    ...
    private void addAnimalNaTabela(Animal cli) {

        DefaultTableModel dtm = (DefaultTableModel) jtAnimal.getModel();

        Object dados[] = {cli.getId(),cli.getNome(), cli.getAnoNasc(), "ESPÉCIE AQUI!!!"};
        
        //incluir o método getEspécie
    ...
    //CRIAR AS FUNCOES DE CADASTRAR NOVO ANIMAL
    //TEM EXEMPLO EM CLIENTEVIEW.JAVA
    ...
    private void initComponents() {
        ...
        jtAnimal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Gênero", "Data de Nascimento", "Espécie"
            }
        ) {
