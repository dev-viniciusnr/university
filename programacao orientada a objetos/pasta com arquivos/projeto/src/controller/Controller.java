...
//    }
    ...
    public static void addAnimal(String nome, int ano, String sexo, int idCliente) {
        AnimalDAO.getInstance().addAnimal(nome, ano, sexo, idCliente);
    }

    public static List<Animal> getAllAnimal(int idCliente) {
        return AnimalDAO.getInstance().getAllAnimais(idCliente);
    }
